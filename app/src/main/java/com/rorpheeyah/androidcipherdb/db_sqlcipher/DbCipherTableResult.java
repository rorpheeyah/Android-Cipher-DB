...
public class DbCipherTableResult {
    ...
    private final DbCipherTableResultHelper mDbHelper;
    ...
    public boolean deleteFirstRecord() {
        ...
        mDatabase.delete(DbCipherTableResultHelper.TABLE_TARGET, DbCipherTableResultHelper.COLUMN_ID + "=?", new String[] {"5"});
